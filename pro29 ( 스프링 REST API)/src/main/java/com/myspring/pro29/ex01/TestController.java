...
public class TestController {
	...
	//브라우저에서 요청시 {num}부분의 값이 @PathVariable로 지정
	...
	public void modify(@RequestBody MemberVO vo){ //json으로 전송된 데이터를 MemberVO객체의 속성에 자동으로 설정
	...
	public ResponseEntity res3() {
		...
		message += " </script>";
		return new ResponseEntity(message, responseHeaders, HttpStatus.CREATED); //ResponseEntity를 이용해 html형식으로 전송
	}
}
