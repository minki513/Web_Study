...
static Logger logger = LoggerFactory.getLogger(BoardController.class);
	...
	@RequestMapping(value="/{articleNO}", method=RequestMethod.GET) //get 방식-글 번호에 대한 글 정보 조회
	...
	@RequestMapping(value="", method=RequestMethod.POST) //post 방식으로 요청하므로 요청시 json으로 전달되는 객체를 새글로 추가
	...
	@RequestMapping(value="/{articleNO}", method=RequestMethod.PUT) //put방식 - articleNo에 대한 글을 전달되는 json 정보로 수정
	...
	@RequestMapping(value="/{articleNO}", method=RequestMethod.DELETE) //delete방식 - 전달되는 articeNO에 대한 글을 삭제
